...
class MethodRelocator(
    ...
    override fun visitParameterAnnotation(
        ...
        val annotationVisitor = super.visitParameterAnnotation(parameter, relocate(descriptor), visible)
        return AnnotationRelocator(api, annotationVisitor, relocators)
    }
    ...
    override fun visitFrame(
        ...
        super.visitFrame(type, numLocal, relocate(local), numStack, relocate(stack))
    }
    ...
    override fun visitMethodInsn(
        ...
        super.visitMethodInsn(opcode, relocate(owner), name, relocate(descriptor))
    }
    ...
    override fun visitInvokeDynamicInsn(
        ...
        if (bootstrapMethodArguments == null || bootstrapMethodArguments.isEmpty()) {
            super.visitInvokeDynamicInsn(name, relocate(descriptor), relocate(bootstrapMethodHandle))
        } else {
            super.visitInvokeDynamicInsn(name, relocate(descriptor), relocate(bootstrapMethodHandle), *relocate(bootstrapMethodArguments)!!)
        }
    }
    ...
    override fun visitLdcInsn(value: Any?) {
        super.visitLdcInsn(relocate(value))
    }
    ...
    override fun visitMultiANewArrayInsn(
        ...
        super.visitMultiANewArrayInsn(relocate(descriptor), numDimensions)
    }
    ...
    override fun visitInsnAnnotation(
        ...
        val annotationVisitor = super.visitInsnAnnotation(typeRef, typePath, relocate(descriptor), visible)
        return AnnotationRelocator(api, annotationVisitor, relocators)
    }
    ...
    override fun visitTryCatchBlock(
        ...
        super.visitTryCatchBlock(start, end, handler, relocate(type))
    }
    ...
    override fun visitTryCatchAnnotation(
        ...
        val annotationVisitor = super.visitTryCatchAnnotation(typeRef, typePath, relocate(descriptor), visible)
        return AnnotationRelocator(api, annotationVisitor, relocators)
    }
    ...
    override fun visitLocalVariableAnnotation(
        ...
        val annotationVisitor = super.visitLocalVariableAnnotation(typeRef, typePath, start, end, index, relocate(descriptor), visible)
        return AnnotationRelocator(api, annotationVisitor, relocators)
    }
