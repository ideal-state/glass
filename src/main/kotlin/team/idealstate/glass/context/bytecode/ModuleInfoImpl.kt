...
import team.idealstate.glass.context.bytecode.module.ModuleExportInfoImpl
import team.idealstate.glass.context.bytecode.module.ModuleOpenInfo
import team.idealstate.glass.context.bytecode.module.ModuleOpenInfoImpl
import team.idealstate.glass.context.bytecode.module.ModuleProvideInfo
import team.idealstate.glass.context.bytecode.module.ModuleProvideInfoImpl
import team.idealstate.glass.context.bytecode.module.ModuleRequireInfo
import team.idealstate.glass.context.bytecode.module.ModuleRequireInfoImpl
import team.idealstate.glass.context.bytecode.module.ModuleUseInfo
import team.idealstate.glass.context.bytecode.module.ModuleUseInfoImpl
...
class ModuleInfoImpl(
    ...
    override fun compile(): ByteArray {
        ...
        classWriter.visit(ClassUtils.version(release), access, "module-info", null, null, null)
        ...
        mainClass?.also { moduleVisitor.visitMainClass(ClassUtils.internalize(it)) }
    ...
    private class ModuleInfoClassVisitor(
        ...
        override fun visit(
            ...
            this.release = ClassUtils.release(version)
        }
